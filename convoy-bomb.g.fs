...
: TASK ;
VARIABLE VB VARIABLE N  VARIABLE AB
: VISA-P HOME ." CONVOY BOMB" 10 SPACES ." SCORE:" N @ 5 .R ;
VARIABLE XF  VARIABLE YF
: FLYGPLAN YF @ + XF @ 128641 xemit ."  ";
\ : FLYGPLAN YF @ + XF @ PLOT YF @ XF @ 6 + PLOT ;
...
: B 0 N ! page VISA-P 0 AB ! 1 VB !  VATTEN
  BEGIN FLYG FLYT ?BOMB @ IF
  FALL ELSE BOMBINIT THEN -1 ?S +! FLYG ?S @ 0= IF
  SUDDA THEN AB @ 5 = UNTIL ;
: INST page CR CR 6 SPACES ." C O N V O Y   B O M B" CR CR
  ." YOUR MISSIONS IS TO SINK THEM!" CR
  ." CONVAY ARE 5 SHIPS LONG." CR
;
: CONVOY-BOMB HIDE-CUR BEGIN INST VISA B HOME 4 0 do cr loop
  ." Do you want to play again ?(Y/N)"
  0 BEGIN DROP KEY DUP DUP [CHAR] n = SWAP [CHAR] y = OR UNTIL
  [CHAR] n = UNTIL page
  ." Bye, hope you take pleasure to play." CR SHOW-CUR ;
CONVOY-BOMB 0 (bye)
